...
class BasicsKtTest {
    ...
    fun inRangeTest() {
        for (n in 1..1000) {
            ...
            assertTrue("The last element in your range is not $n", r.endInclusive == n)
            // for (v in r) {
    ...
    fun wordCounter() {
        //Case sensitive
        assertEquals(mapOf("vasilis" to 2, "Vasilis" to 1, "davios" to 2, "Davios" to 1)
                , wordCounter(arrayOf("vasilis Vasilis vasilis", "davios davios Davios")))


        assertEquals(mapOf("Vasilis" to 1, "is" to 2, "a" to 2, "student" to 2, "of" to 2, "Msc" to 2, "in" to 2,"Computer" to 2,
                "Science" to 2, "at" to 2, "Bbk" to 2, "University." to 1, "Davios" to 1, "University!" to 1),
                wordCounter(arrayOf("Vasilis is a student of Msc in Computer Science at Bbk University.",
                        "Davios is a student of Msc in Computer Science at Bbk University!")))
    }
